...

{
        ...
        type = self.lib.types.function (self.lib.types.args (
          { lib, ... }:
          {
            options = {
              ...
              lib = lib.mkOption {
                type = lib.types.raw;
                description = "The library attrset to document (e.g. nixpkgs `lib`).";
              };
            };
          }
        )) lib.types.str;
  ...
  flake.lib.docs.function =
    let
      ...
      # NOTE: reimplemented here to not cause infinite recursion on the actual function
      toFunctor =
        x:
    ...
    in
    undocumented {
      description = "Attach documentation (and optional runtime assertions) to a function.";
      asserted = true;
      type = self.lib.types.function (self.lib.types.args {
        options = {
          type = lib.mkOption {
            description = "Function type";
            # TODO: find alternative to addCheck? https://github.com/NixOS/nixpkgs/issues/396021
