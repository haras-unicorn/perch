    ...
    self.lib.docs.function
      {
        ...
        description = "Converts evaluated options to a human-friendly string useful for function arguments";
      }
      (
        evaluatedOptions:
        let
          ...
          optionDescriptionToStringOrNull =
            ...
            in
            if optionDescription == null || optionDescription == "" then null else optionDescription;
